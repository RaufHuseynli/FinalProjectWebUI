        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SiteInfos_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductColorSizeCount_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SiteSocial", x => new { x.SocialId, x.SiteInfoId });
                    table.ForeignKey(
                        name: "FK_SiteSocial_SiteInfos_SiteInfoId",
                        column: x => x.SiteInfoId,
                        principalTable: "SiteInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SiteSocial_SocialLinks_SocialId",
                        column: x => x.SocialId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductColorSizeCount_SizeId",
                table: "ProductColorSizeCount",
                column: "SizeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SiteInfos_StoreId",
                table: "SiteInfos",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_SiteSocial_SiteInfoId",
                table: "SiteSocial",
                column: "SiteInfoId");
